...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<title>User Persona Kristi</title>
		<h1>User Kristi of website VerizonWireless.com</h1>
		<body>
		<div>
		<img src="image-kristi.jpg" alt="Kristi" width="945" height="630"</img>
		</div>
			<p>
			Kristi is a user who is an Counseling Professional and uses the site to pay her bill.
		</p>
		<p>
			Kristi is a mom of 3 and has a phone plan for her husband and 2 of her three kids.
		</p>
		<ul>
			<li>Kristi is familiar with technology but uses the site primarily to pay her monthly bill.</li>
			<li>Kristi has an income of over $40,000 US, her husband also works for the Forestry Service.</li>
